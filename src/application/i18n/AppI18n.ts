...
const messages = {
  'zh-CN': {
    ...
    'input.hintDefault': 'Enter 发送  :tool-focus 浏览工具  Ctrl+O 记录',
    'input.toolBrowsePlaceholder': '正在浏览工具详情',
    'input.hintToolBrowse': '工具浏览：↑/↓ 选择  Enter/Space 展开  Esc/Q 退出',
    ...
    'conversation.scrollHidden': '… 上方还有 {count} 行（PgUp/PgDn 滚动，Ctrl+O 完整记录，Esc 回到最新）',
    'conversation.scrollHiddenOne': '… 上方还有 1 行（PgUp/PgDn 滚动，Ctrl+O 完整记录，Esc 回到最新）',
    'conversation.scrollHiddenShort': '… 上方 {count} 行',
    'conversation.scrollPosition': '… 上方 {above} 行 / 下方 {below} 行（Ctrl+O 完整记录，Esc 回到最新）',
    'conversation.scrollPositionShort': '… ↑{above} ↓{below}',
    'conversation.scrollTop': '… 已到顶部（Esc 回到最新）',
    'conversation.hintControls': 'PgUp/PgDn · :tool-focus 工具详情 · Ctrl+O 记录',
    ...
    'command.desc.toolFocus': '进入工具详情浏览，用普通方向键逐条操作',
  ...
  en: {
    ...
    'input.hintDefault': 'Enter send  :tool-focus browse tools  Ctrl+O transcript',
    'input.toolBrowsePlaceholder': 'Browsing tool details',
    'input.hintToolBrowse': 'Tool browse: ↑/↓ select  Enter/Space expand  Esc/Q exit',
    ...
    'conversation.scrollHidden': '… {count} lines above (PgUp/PgDn scroll, Ctrl+O full transcript, Esc latest)',
    'conversation.scrollHiddenOne': '… 1 line above (PgUp/PgDn scroll, Ctrl+O full transcript, Esc latest)',
    'conversation.scrollHiddenShort': '… {count} above',
    'conversation.scrollPosition': '… {above} above / {below} below (Ctrl+O full transcript, Esc latest)',
    'conversation.scrollPositionShort': '… ↑{above} ↓{below}',
    'conversation.scrollTop': '… top reached (Esc for latest)',
    'conversation.hintControls': 'PgUp/PgDn · :tool-focus tool details · Ctrl+O transcript',
    ...
    'command.desc.toolFocus': 'Browse individual tool details with plain arrow keys',
