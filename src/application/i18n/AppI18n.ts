...
const messages = {
  'zh-CN': {
    ...
    'empty.tipLabel': '提示',
    'empty.tip.1': '输入 `:theme system` 让配色跟随终端明暗。',
    'empty.tip.2': '按 Tab 浏览工具调用详情，Enter 展开，Esc 返回输入。',
    'empty.tip.3': '`:mode plan` 先规划，`:mode agent` 放手执行。',
    'empty.tip.4': 'PgUp/PgDn 翻阅历史，Ctrl+G 直接回到底部。',
    'empty.tip.5': '输入 `:sessions` 切换会话，`:help` 查看全部命令。',
    ...
    'input.hintDefault': 'Enter 发送  ↑/↓ 历史  Tab 工具  PgUp/PgDn 翻页',
    'input.toolBrowsePlaceholder': '正在浏览工具详情',
    'input.hintToolBrowse': '↑/↓ 选择工具  Enter 展开/收起  Esc/Tab 回到输入',
    ...
    'taskDock.title': '任务',
    'todoDock.title': '待办',
    'todoDock.reminder': '还有 {count} 项待办未完成。',
    ...
    'status.approvalChoiceRequired': '请使用方向键选择审批选项并回车确认。',
    'status.responseCompleted': '已完成一轮响应。',
    'status.modelRetrying': '模型请求失败，正在重试（{attempt}/{max}），{delay}ms 后继续…',
    ...
    'conversation.working': '正在分析并执行',
    'conversation.configError': '错误：{message}',
    'conversation.scrollHidden': '↑ {count} · PgUp/PgDn · Ctrl+O 完整记录',
    'conversation.scrollHiddenOne': '↑ 1 · PgUp/PgDn · Ctrl+O 完整记录',
    'conversation.scrollHiddenShort': '… 上方 {count} 行',
    'conversation.scrollPosition': '↑ {above} · ↓ {below} · Ctrl+O 完整记录',
    'conversation.scrollPositionShort': '… ↑{above} ↓{below}',
    'conversation.scrollTop': '… 已到顶部（Esc 回到最新）',
    'conversation.hintControls': 'Tab 聚焦工具 · ↑/↓ 选择 · Enter 展开 · PgUp/PgDn 翻页',
    'conversation.transcriptTitle': '全屏记录',
    'conversation.transcriptHint': 'PgUp/PgDn 滚动 · Esc 回到底部/退出 · Ctrl+O 退出',
    'conversation.toolExpandHint': 'Ctrl+E 展开',
    'conversation.toolCollapseHint': 'Ctrl+E 收起',
    'conversation.toolLineCount': '{count} 行',
    'collapse.hidden': '… 另有 {count} 行未显示',
    'collapse.hiddenOne': '… 另有 1 行未显示',
    'collapse.hiddenShort': '… 另 {count} 行',
    'collapse.toolHidden': '… 另有 {count} 行 · Ctrl+E 展开',
    'collapse.toolHiddenOne': '… 另有 1 行 · Ctrl+E 展开',
    ...
    'transcript.turnLimit': '已达到本轮 {count} 次模型/工具循环上限。请继续任务以开启下一轮。',
    'transcript.repeatedToolStopped': '检测到工具 {tool} 连续使用相同参数调用超过 {count} 次，已停止重复循环。',

    'config.selectProviderTitle': '请选择 AI Provider：',
    'config.customProvider': '自定义 OpenAI 兼容端点',
    'config.enterIndexContinue': '使用方向键选择并回车确认',
    'config.selectModelTitle': '已选择 {provider}，请选择模型：',
    'config.defaultSuffix': '（默认）',
    'config.selectModelInstruction': '使用方向键选择并回车确认',
    ...
    'config.confirmInstruction': '使用方向键选择保存或取消，然后回车确认',
    ...
    'approval.instruction': 'y 批准   n 拒绝   a 本会话内始终允许这条规则',
    'input.hintChoiceTabs': '↑/↓/←/→ 选择   Enter 确认   Esc 返回',
    'approval.choice.approve': '批准一次',
    'approval.choice.deny': '拒绝',
    'approval.choice.always': '本会话允许',
    ...
    'approval.alwaysApprovedStatus': '已批准，且本会话内相同作用域与操作不再询问',
    ...
    'command.desc.theme': '切换配色主题（跟随系统 / 亮色 / 暗色）',
    'command.desc.permissions': '切换工具自主执行与审批模式',
    'command.desc.runtime': '查看或调整模型、工具与子代理执行预算',
    ...
    'cli.theme.usage': '用法：:theme <light|dark|system>',
    'cli.theme.current': '当前主题：{value}（生效配色：{resolved}）',
    'cli.theme.saved': '主题已切换并保存为 {value}，生效配色：{resolved}。',
    'cli.theme.invalid': '不支持的主题：{value}。可选值：light、dark、system。',
    'cli.permissions.current': '当前权限模式：{value}',
    'cli.permissions.usage': '用法：:permissions <manual|workspace|auto|plan>',
    'cli.permissions.saved': '权限模式已切换并保存为 {value}，立即生效。',
    'cli.permissions.invalid': '不支持的权限模式：{value}。可选值：manual、workspace、auto、plan。',
    'permissions.selectTitle': '选择工具权限模式',
    'permissions.mode.manual': '逐项审批',
    'permissions.mode.manual.description': '写入与命令逐项确认',
    'permissions.mode.workspace': '工作区自主',
    'permissions.mode.workspace.description': '编辑与验证自动执行',
    'permissions.mode.auto': '自动模式',
    'permissions.mode.auto.description': '仅高风险和越界询问',
    'permissions.mode.plan': '计划模式',
    'permissions.mode.plan.description': '只读分析，禁止修改',
    'status.selectPermissionMode': '请选择权限模式。',
    'status.permissionSelectionCancelled': '已取消权限模式选择。',
    'assistantMode.selectTitle': '选择会话模式（Shift+Tab）',
    'assistantMode.chat': '对话',
    'assistantMode.chat.description': '解释与讨论，不主动执行',
    'assistantMode.agent': '执行',
    'assistantMode.agent.description': '自主编码、验证和交付',
    'assistantMode.plan': '规划',
    'assistantMode.plan.description': '可写规划文档，源码保持只读',
    'status.selectAssistantMode': '请选择会话模式。',
    'status.assistantModeSelectionCancelled': '已取消会话模式选择。',
    'status.workflowPhase.plan': 'AI 正在规划：当前阶段只允许读取与分析。',
    'status.workflowPhase.execute': '规划完成，AI 已进入执行阶段。',
    ...
    'cli.config.commandHelpSetContextWindow': '- :config set context-window <tokens>',
    ...
    'cli.config.errorInvalidContextWindow': '无效的上下文窗口：{value}，至少需要 4096 tokens。',
  ...
  en: {
    ...
    'empty.tipLabel': 'Tip',
    'empty.tip.1': 'Type `:theme system` to make colors follow your terminal.',
    'empty.tip.2': 'Press Tab to browse tool calls, Enter to expand, Esc to return.',
    'empty.tip.3': '`:mode plan` to think first, `:mode agent` to let it run.',
    'empty.tip.4': 'PgUp/PgDn scrolls history; Ctrl+G jumps back to the bottom.',
    'empty.tip.5': 'Type `:sessions` to switch sessions, `:help` for all commands.',
    ...
    'input.hintDefault': 'Enter send  Up/Down history  Tab tools  PgUp/PgDn page',
    'input.toolBrowsePlaceholder': 'Browsing tool details',
    'input.hintToolBrowse': 'Up/Down select tool  Enter expand/collapse  Esc/Tab return to input',
    ...
    'todoDock.reminder': '{count} todo(s) still pending.',
    ...
    'status.approvalChoiceRequired': 'Use arrow keys to choose an approval option, then press Enter.',
    'status.responseCompleted': 'Completed one response.',
    'status.modelRetrying': 'Model request failed; retrying ({attempt}/{max}) in {delay}ms…',
    ...
    'conversation.working': 'analyzing and working',
    'conversation.configError': 'Error: {message}',
    'conversation.scrollHidden': '↑ {count} · PgUp/PgDn · Ctrl+O transcript',
    'conversation.scrollHiddenOne': '↑ 1 · PgUp/PgDn · Ctrl+O transcript',
    'conversation.scrollHiddenShort': '… {count} above',
    'conversation.scrollPosition': '↑ {above} · ↓ {below} · Ctrl+O transcript',
    'conversation.scrollPositionShort': '… ↑{above} ↓{below}',
    'conversation.scrollTop': '… top reached (Esc for latest)',
    'conversation.hintControls': 'Tab focus tools · Up/Down select · Enter expand · PgUp/PgDn page',
    'conversation.transcriptTitle': 'TRANSCRIPT',
    'conversation.transcriptHint': 'PgUp/PgDn scroll · Esc latest/close · Ctrl+O close',
    'conversation.toolExpandHint': 'Ctrl+E expand',
    'conversation.toolCollapseHint': 'Ctrl+E collapse',
    'conversation.toolLineCount': '{count} lines',
    'collapse.hidden': '… {count} more lines hidden',
    'collapse.hiddenOne': '… 1 more line hidden',
    'collapse.hiddenShort': '… {count} more',
    'collapse.toolHidden': '… {count} more · Ctrl+E expand',
    'collapse.toolHiddenOne': '… 1 more · Ctrl+E expand',
    ...
    'transcript.turnLimit': 'Reached the {count}-iteration model/tool loop limit. Continue the task to start another turn.',
    'transcript.repeatedToolStopped': 'Stopped a loop after tool {tool} exceeded {count} consecutive calls with identical input.',

    'config.selectProviderTitle': 'Select an AI provider:',
    'config.customProvider': 'Custom OpenAI-compatible endpoint',
    'config.enterIndexContinue': 'Use arrow keys and Enter to confirm',
    'config.selectModelTitle': '{provider} selected. Choose a model:',
    'config.defaultSuffix': ' (default)',
    'config.selectModelInstruction': 'Use arrow keys and Enter to confirm',
    ...
    'config.confirmModel': 'Model: {value}',
    'config.confirmApiKey': 'API Key: {value}',
    'config.confirmInstruction': 'Choose save or cancel with arrow keys, then press Enter',
    ...
    'approval.instruction': 'y approve   n deny   a always allow this scoped operation in this session',
    'input.hintChoiceTabs': '↑/↓/←/→ select   Enter confirm   Esc back',
    'approval.choice.approve': 'Approve once',
    'approval.choice.deny': 'Deny',
    'approval.choice.always': 'Allow this session',
    ...
    'approval.alwaysApprovedStatus': 'Approved; the same scoped operation will not ask again this session',
    ...
    'command.desc.theme': 'Switch color theme (system / light / dark)',
    'command.desc.permissions': 'Switch autonomous tool execution and approval mode',
    'command.desc.runtime': 'Inspect or tune model, tool, and sub-agent execution budgets',
    ...
    'cli.theme.usage': 'Usage: :theme <light|dark|system>',
    'cli.theme.current': 'Current theme: {value} (active palette: {resolved})',
    'cli.theme.saved': 'Theme switched and saved as {value}; active palette: {resolved}.',
    'cli.theme.invalid': 'Unsupported theme: {value}. Available values: light, dark, system.',
    'cli.permissions.current': 'Current permission mode: {value}',
    'cli.permissions.usage': 'Usage: :permissions <manual|workspace|auto|plan>',
    'cli.permissions.saved': 'Permission mode switched and saved as {value}; it is active now.',
    'cli.permissions.invalid': 'Unsupported permission mode: {value}. Available values: manual, workspace, auto, plan.',
    'permissions.selectTitle': 'Choose a tool permission mode',
    'permissions.mode.manual': 'Manual',
    'permissions.mode.manual.description': 'Confirm edits and commands',
    'permissions.mode.workspace': 'Workspace',
    'permissions.mode.workspace.description': 'Auto-run edits and verification',
    'permissions.mode.auto': 'Auto',
    'permissions.mode.auto.description': 'Ask only for high-risk or outside scope',
    'permissions.mode.plan': 'Plan',
    'permissions.mode.plan.description': 'Read-only analysis',
    'status.selectPermissionMode': 'Choose a permission mode.',
    'status.permissionSelectionCancelled': 'Permission mode selection cancelled.',
    'assistantMode.selectTitle': 'Choose session mode (Shift+Tab)',
    'assistantMode.chat': 'Chat',
    'assistantMode.chat.description': 'Explain and discuss without acting',
    'assistantMode.agent': 'Agent',
    'assistantMode.agent.description': 'Implement, verify, and deliver',
    'assistantMode.plan': 'Plan',
    'assistantMode.plan.description': 'Write plan documents; keep source read-only',
    'status.selectAssistantMode': 'Choose a session mode.',
    'status.assistantModeSelectionCancelled': 'Session mode selection cancelled.',
    'status.workflowPhase.plan': 'AI is planning; this phase is restricted to reading and analysis.',
    'status.workflowPhase.execute': 'Planning complete; AI entered the execution phase.',
    ...
    'cli.config.errorInvalidContextWindow': 'Invalid context window: {value}; it must be at least 4096 tokens.',
