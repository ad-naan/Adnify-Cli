...
const messages = {
  'zh-CN': {
    ...
    'input.hintConfigInit': '上下选择  Enter 确认/继续  Esc 退出配置',
    ...
    'command.desc.language': '切换界面与模型回复语言',
    'command.desc.animation': '设置终端动效级别',
    ...
    'command.desc.restore': '列出或恢复文件级快照',
    ...
    'cli.language.current': '当前语言：{value}',
    'cli.language.usage': '用法：:language <zh-CN|en>',
    'cli.language.saved': '语言已保存为 {value}。重启 Adnify-Cli 后，界面和模型默认回复语言会一起生效。',
    'cli.language.invalid': '不支持的语言：{value}。可选值：zh-CN、en。',
    'cli.animation.usage': '用法：:animation <off|minimal|full>',
    'cli.animation.saved': '动效级别已保存为 {value}。重启 Adnify-Cli 后生效。',
    'cli.animation.invalid': '不支持的动效级别：{value}。可选值：off、minimal、full。',
    ...
    'cli.config.commandHelpSetProvider':
      '- :config set provider <openai-compatible|openai-responses|anthropic|google> [model]',
  ...
  en: {
    ...
    'input.hintConfigInit': 'Up/Down select  Enter confirm/continue  Esc exit setup',
    ...
    'config.modelRequired': 'Model name is required',
    ...
    'command.desc.language': 'Switch the UI and default response language',
    'command.desc.animation': 'Set the terminal animation level',
    ...
    'command.desc.restore': 'List or restore file snapshots',
    ...
    'cli.language.current': 'Current language: {value}',
    'cli.language.usage': 'Usage: :language <zh-CN|en>',
    'cli.language.saved': 'Language saved as {value}. Restart Adnify-Cli to update both the UI and default model response language.',
    'cli.language.invalid': 'Unsupported language: {value}. Available values: zh-CN, en.',
    'cli.animation.usage': 'Usage: :animation <off|minimal|full>',
    'cli.animation.saved': 'Animation level saved as {value}. Restart Adnify-Cli to apply it.',
    'cli.animation.invalid': 'Unsupported animation level: {value}. Available values: off, minimal, full.',
